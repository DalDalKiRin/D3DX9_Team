...
protected:
	cCamera*						pMainCamera;
	LPDIRECT3DCUBETEXTURE9			environmentTexture;			// # 환경 Texture #
	LPD3DXMESH						environmentSphereMesh;		// # 환경 구 #
	LPD3DXEFFECT					environmentEffect;			// # 환경 Effect #
	...
	cLight_Direction*				pSceneBaseDirectionLight;	// # 씬에 배치된 기본 라이팅 #
