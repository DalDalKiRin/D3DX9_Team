...
void cAlice2::Update(float timeDelta)
{
...
void cAlice2::MESH_LOAD()
{
	...
	cXMesh_Skinned* pSkinned =
		...
		("../Resources/Enemy/Alice2/Alice2.X", &matCorrection);
...
void cAlice2::AddTarget(cBaseObject * targetObj)
{
}
