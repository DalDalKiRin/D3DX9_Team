...
void cTrailRender::Init(float trailLiveTime, float width, LPDIRECT3DTEXTURE9 pTrailTex, D3DXCOLOR color, LPDIRECT3DTEXTURE9 pDistortTex)
{
	...
	this->m_nTrailMaxNum = (int)(trailLiveTime * 60) + 10;
...
void cTrailRender::Render()
{
	...
	this->Transform.RenderGizmo(Device);
	this->m_LeftTransform.RenderGizmo(Device);
	this->m_RightTransform.RenderGizmo(Device);
}
